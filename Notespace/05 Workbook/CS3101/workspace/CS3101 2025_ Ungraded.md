...
```c 
   ...
   {  
   	...
   	printf("Puzzle: The day before two days after the day before tomorrow is Saturday. What day is it today?\\n\\n");  
...
```c
...

   {
   	...
   	int apple\_n \= 5, mango\_n \= 10, banana\_n \= 50, pineapple\_n \= 40, papaya\_n \= 15;

   	float apple\_p \= 10.0, mango\_p \= 50.0, banana\_p \= 5.0, pineapple\_p \= 55.5, papaya\_p \= 30.5;
...

   	{
   		...
   		case 0:    //Apple
...

   					{
   						...
   						printf("Bill \= %f INR", qty\*apple\_p);
    		...
    		case 1:    //Mango
...

   					{
   						...
   						printf("Bill \= %f INR", qty\*mango\_p);
   		...
   		case 2:    //Banana
...

   					{
   						...
   						printf("Bill \= %f INR", qty\*banana\_p);
   		...
   		case 3:    //Pineapple
...

   					{
   						...
   						printf("Bill \= %f INR", qty\*pineapple\_p);
   		...
   		case 4:    //Papaya
...

   					{
   						...
   						printf("Bill \= %f INR", qty\*papaya\_p);
