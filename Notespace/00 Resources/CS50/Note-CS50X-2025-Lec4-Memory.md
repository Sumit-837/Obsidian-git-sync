...
![smiley Zeros and ones being converted to a black and white smiley](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide015.png)
...
![hex in photoshop A photoshop panel with RGB values and hexadecimal input](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide016.png)
...
![memory hex Blocks of memory numbered in hex](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide065.png)
...
![0x blocks of memory numbered in hex with 0x](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide066.png)
...
![hex the value 50 stored in a memory location with hex](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide070.png)
...
![pointer Same value of 50 in a memory location with a pointer value stored elsewhere](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide078.png)
...
![pointer A pointer as an arrow, pointing from one location of memory to another](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide079.png)
...
![hi The string HI with an exclamation point stored in memory](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide085.png)
...
![hi pointer Same string HI with a pointer pointing to it](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide086.png)
...
![two strings two strings stored separately in memory](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide115.png)
...
![two strings two pointers pointing at the same memory location with a string](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide124.png)
...
![stack and heap a rectangle with machine code at top followed by globals heap and stack](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide163.png)
...
![frames a rectangle with main function at bottom and swap function directly above it](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide167.png)
...
![swap by reference a and b stored in main function being passed by reference to the swap function](https://cs50.harvard.edu/x/notes/4/cs50Week4Slide198.png)
