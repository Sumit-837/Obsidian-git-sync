...
![complexity chart with: "size of problem" as x-axis; "time to solve" as y-axis; red, steep straight line from origin to top of graph close to yellow, less-steep straight line from origin to top of graph, both labeled "n"; green, curved line that gets less and less steep from origin to right of graph, labeled "log n"](https://cs50.harvard.edu/x/notes/3/cs50Week3Slide010.png)
...
![lockers Seven red lockers side by side](https://cs50.harvard.edu/x/notes/3/cs50Week3Slide018.png)
...
![lockers as algorithm seven red lockers pointing to an empty box. Out of the empty box comes an output of bool](https://cs50.harvard.edu/x/notes/3/cs50Week3Slide022.png)
...
![big o graphed chart with: "size of problem" as x-axis; "time to solve" as y-axis; red, steep straight line from origin to top of graph close to yellow, less-steep straight line from origin to top of graph, both labeled "O(n)"; green, curved line that gets less and less steep from origin to right of graph, labeled "O(log n"](https://cs50.harvard.edu/x/notes/3/cs50Week3Slide042.png)
...
![red lockers Seven red lockers side by side with the last labeled as n-1](https://cs50.harvard.edu/x/notes/3/cs50Week3Slide104.png)
